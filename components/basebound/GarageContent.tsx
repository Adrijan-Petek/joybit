...
export function GarageContent({
  ...
  return (
    <div className={compact ? 'h-full w-full p-3' : 'h-full w-full p-4'}>
              ...
              {UPGRADE_ROWS.map(row => {
                ...
                return (
                  <div
                    ...
                    className={
                      compact
                        ? 'flex items-center justify-between gap-2 border border-gray-800 rounded-lg p-2 bg-black/40'
                        : 'flex items-center justify-between gap-3 border border-gray-800 rounded-lg p-3 bg-black/40'
                    }
                  >
                    <div>
                    ...
                    <button
                      className={
                        isMaxed
                          ? (compact
                              ? 'px-3 py-1.5 rounded bg-gray-800 text-gray-400 cursor-not-allowed text-xs'
                              : 'px-4 py-2 rounded bg-gray-800 text-gray-400 cursor-not-allowed')
                          : canBuy
                            ? (compact
                                ? 'px-3 py-1.5 rounded bg-yellow-600 hover:bg-yellow-500 text-black font-bold text-xs'
                                : 'px-4 py-2 rounded bg-yellow-600 hover:bg-yellow-500 text-black font-bold')
                            : (compact
                                ? 'px-3 py-1.5 rounded bg-gray-700 text-gray-300 cursor-not-allowed text-xs'
